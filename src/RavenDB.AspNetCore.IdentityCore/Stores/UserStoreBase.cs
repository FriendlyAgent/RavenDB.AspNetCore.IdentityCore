...
{
    public abstract class UserStoreBase<TUser, TSession, TUserClaim, TUserLogin, TUserToken> :
        ...
        where TUserToken : IdentityUserToken, new()
    {
        ...
        /// <param name="user">The user for which to create the constraint.</param>
        /// <returns></returns>
        public static UniqueEmail ToEmailConstraint(IdentityUser user)
        {
    ...
    public abstract class UserStoreBase<TUser, TRole, TSession, TUserClaim, TUserLogin, TUserToken, TRoleClaim> :
